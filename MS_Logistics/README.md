...
Microserviço para **gerenciamento logístico e de entregas**. Controla rotas otimizadas, rastreamento em tempo real, agendamento de visitas, cálculo de distâncias, gestão de frota, otimização de deslocamentos dos técnicos e integração com APIs de mapas.

### 🎯 Principais Funcionalidades

- 🗺️ **Rotas**: Otimização e planejamento de rotas
- 📍 **Rastreamento**: Localização em tempo real
- 📅 **Agendamentos**: Scheduling inteligente
- 🚚 **Frota**: Gestão de veículos e técnicos
- 📊 **Analytics**: Métricas de performance logística
- 🧭 **Navegação**: Integração com Google Maps/Waze
- ⏱️ **ETA**: Estimativa de tempo de chegada
- 📱 **Mobile**: APIs para apps de entregadores
...
```bash
git clone https://github.com/EmmanuelSMenezes/PAM_MS_Logistics.git
cd PAM_MS_Logistics
```
...
{
  "ConnectionStrings": {
    "DefaultConnection": "Server=localhost;Database=PAM_PAM_MS_Logistics;Trusted_Connection=true;MultipleActiveResultSets=true"
  }
}
```
...
```bash
# Build da imagem
docker build -t pam_ms_logistics .
...
- **Local**: `http://localhost:5007/swagger`
- **Produção**: `https://api.pam.com/pam_ms_logistics/swagger`
...
- **🐛 Issues**: [GitHub Issues](https://github.com/EmmanuelSMenezes/PAM_MS_Logistics/issues)
- **📖 Wiki**: [Documentação Completa](https://github.com/EmmanuelSMenezes/PAM_MS_Logistics/wiki)
...
**[⬆ Voltar ao Topo](#-PAM_MS_Logistics)**
